...
int main()
{
    ...
    while(!glfw_window.Get_Window_Should_Close())
    {
        ...
        shader1.Set_Uniform_3Float("objectColor", 1.0f, 0.5f, 0.31f);
        shader1.Set_Uniform_3Float("lightColor",  1.0f, 1.0f, 1.0f);
        shader1.Set_Uniform_3Float("lightPos", lightPos.x, lightPos.y, lightPos.z);
