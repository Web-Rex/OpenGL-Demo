...
if(NOT ${TARGET_SET_WARNINGS_ENABLE})
    message(STATUS "Warnings Disabled For: ${PROJECT_NAME}")
    return()
else()
    message(STATUS "Warnings Active For: ${PROJECT_NAME}")
...
# -- [...] provide install information
include(GNUInstallDirs) # is aware of paths for all operating systems
install(
        TARGETS ${PROJECT_NAME}
        RUNTIME DESTINATION ${CMAKE_INSTALL_BINDIR}/src
)