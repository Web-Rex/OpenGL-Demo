...
public:
    ...
    void Set_Uniform_3Float(const char* name, float x, float y, float z) const;
    void Set_Uniform_4Float(const char* name, float x, float y, float z, float w) const;
    void Set_Uniform_4FMatrix(const char* name, glm::mat4 mvp) const;
};