...
void Shader::Set_Uniform_Bool(const char* name, bool value) const
{
...
void Shader::Set_Uniform_3Float(const char* name, float x, float y, float z) const
{
    glUniform3f(Get_Uniform_Location(name), x, y, z);
}
void Shader::Set_Uniform_4Float(const char* name, float x, float y, float z, float w) const
{
    glUniform4f(Get_Uniform_Location(name), x, y, z, w);
}
void Shader::Set_Uniform_4FMatrix(const char* name, glm::mat4 mvp) const
{
...
int Shader::Get_Uniform_Location(const char* name) const
{
    ...
    if (location == -1)
    {
        ...
        std::cout << "Can not find uniform: " << location << " name - " << name << "\n";
    }
