...
int main()
{
    ...
    while(!glfw_window.Get_Window_Should_Close())
    {
        ...
        shader1.Set_Uniform_3Float("light.diffuse",  1.0f, 1.0f, 1.0f); // darken diffuse light a bit
        ...
        // shader1.Set_Uniform_3Float("light.position",  camera.Get_Camera_Pos().x, camera.Get_Camera_Pos().y, camera.Get_Camera_Pos().z);
        shader1.Set_Uniform_3Float("light.position",  lightPos.x, lightPos.y, lightPos.z);
        shader1.Set_Uniform_3Float("light.direction", camera.Get_Camera_Dir().x, camera.Get_Camera_Dir().y, camera.Get_Camera_Dir().z);
        shader1.Set_Uniform_Float("light.cutOff",   glm::cos(glm::radians(12.5f)));
        shader1.Set_Uniform_Float("light.outerCutOff", glm::cos(glm::radians(17.5f)));

        shader1.Set_Uniform_Float("light.constant",  1.0f);
        shader1.Set_Uniform_Float("light.linear",    0.09f);
        shader1.Set_Uniform_Float("light.quadratic", 0.032f);
